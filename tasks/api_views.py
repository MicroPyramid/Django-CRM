...
class TaskListView(APIView):
    ...
    @swagger_auto_schema(
        tags=["Tasks"],
        manual_parameters=swagger_params.task_list_get_params
    )
    ...
    @swagger_auto_schema(
        tags=["Tasks"],
        manual_parameters=swagger_params.task_create_post_params
    )
...
class TaskDetailView(APIView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_superuser or self.request.user.role == "ADMIN":
            ...
            users_mention = [
                {"username": self.task_obj.created_by.username}]
        else:
            users_mention = list(
    ...
    @swagger_auto_schema(
        tags=["Tasks"],
        manual_parameters=swagger_params.task_delete_params
    )
    ...
    @swagger_auto_schema(
        tags=["Tasks"],
        manual_parameters=swagger_params.task_detail_post_params
    )
    ...
    def delete(self, request, pk, **kwargs):
        ...
        if (
            ...
            return Response({"error": False,
                            ...
                            status=status.HTTP_200_OK)
        return Response({"error": True,
                         "errors": "you don't have permission to delete this task"},
...
class TaskCommentView(APIView):
    ...
    @swagger_auto_schema(
        tags=["Tasks"],
        manual_parameters=swagger_params.task_comment_edit_params
    )
