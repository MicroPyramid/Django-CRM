                    ...
                    <div class="w-full max-w-md">
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="lg:hidden mb-6">
                                    <div class="bg-blue-50 rounded-xl p-4 border border-blue-100">
                                        <div class="flex items-center mb-3">
                                            <Zap class="w-5 h-5 text-blue-600 mr-2" />
                                            <span class="font-semibold text-blue-900 text-sm">Free CRM Features</span>
                                        </div>
                                        <ul class="space-y-2 text-xs text-blue-700">
                                            <li class="flex items-center">
                                                <Check class="w-3 h-3 mr-2 flex-shrink-0" />
                                ...
                                <div>
                                    <a href="{data['google_url']}"
                                       ...
                                       class="group w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 text-gray-800 font-semibold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-200 relative overflow-hidden">
                        ...
                        <div class="mt-6 text-center">
                            <p class="text-blue-100 text-sm">
                                New to BottleCRM?
                                <a href="/" class="text-yellow-300 hover:text-yellow-200 font-medium underline">
