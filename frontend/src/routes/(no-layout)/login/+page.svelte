      ...
      <div class="space-y-8">
        ...
        <div class="grid gap-4">
          {#each features as feature}
            <div
              class="group flex items-start gap-4 rounded-xl border border-slate-800 bg-slate-800/50 p-4 transition-all hover:border-slate-700 hover:bg-slate-800"
            >
              <div
    ...
    <div class="flex flex-1 items-center justify-center p-8">
      <div class="w-full max-w-sm">
        ...
        <div class="space-y-4">
          ...
          >
            ...
            {:else}
              ...
              <ArrowRight
                class="ml-auto h-4 w-4 text-slate-400 transition-transform group-hover:translate-x-0.5"
              />
            {/if}
          </a>
        </div>
        ...
        <div class="mt-8 lg:hidden">
          <p class="mb-3 text-xs font-medium tracking-wider text-slate-400 uppercase">
            What you get
          </p>
