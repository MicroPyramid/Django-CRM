...
<PageHeader title="Documents">
  ...
  {#snippet actions()}
    ...
    <a class="v2-btn v2-btn-primary" href="/v2/documents/new"><Upload />Upload</a>
  {/snippet}
</PageHeader>
...
<div class="v2-scroll">
  {#if visible.length === 0}
    ...
    >
      ...
      {#snippet actions()}
        <a class="v2-btn v2-btn-primary" href="/v2/documents/new">Upload a document</a>
      {/snippet}
    </EmptyState>
  {:else}
        ...
        <tbody>
          {#each visible as d (d.id)}
            ...
            <tr class:archived={d.status === 'inactive'}>
              ...
              <td class="v2-r">
                {#if d.can_write}
                  <a class="edit" href="/v2/documents/{d.id}/edit" title="Manage this document">
                    <Pencil size={13} />
                  </a>
                {/if}
              </td>
