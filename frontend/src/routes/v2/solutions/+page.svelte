...
<PageHeader title="Knowledge base">
  ...
  {/snippet}
  {#snippet actions()}
    <a class="v2-btn v2-btn-primary" href="/v2/solutions/new"><Plus />New article</a>
  {/snippet}
</PageHeader>
...
<div class="v2-scroll">
  {#if articles.length === 0}
    ...
    >
      ...
      {#snippet actions()}
        {#if filtered}
          <a class="v2-btn" href="/v2/solutions">Clear filters</a>
        {/if}
        <a class="v2-btn v2-btn-primary" href="/v2/solutions/new">New article</a>
        <a class="v2-btn" href="/v2/tickets">Go to tickets</a>
      {/snippet}
    </EmptyState>
  {:else}
          ...
          {#each articles as s (s.id)}
            <tr>
              <td style="white-space:normal;max-width:460px" data-m="title">
                <a class="v2-row-link" href="/v2/solutions/{s.id}">
    ...
    <p class="v2-sub v2-pad" style="font-size:12px;padding-bottom:24px">
      ...
      {#if filtered}
        · <a href="/v2/solutions" style="color:inherit">clear filters</a>
      {/if}
    </p>
  {/if}
</div>
