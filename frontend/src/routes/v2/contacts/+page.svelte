...
<PageHeader title="Contacts">
  ...
  {#snippet actions()}
    {#if data.includeInactive}
      <a class="v2-btn" href="/v2/contacts">Hide inactive</a>
    {:else}
      <a class="v2-btn" href="/v2/contacts?inactive=1">Show inactive</a>
    {/if}
    <a class="v2-btn v2-btn-primary" href="/v2/contacts/new"><Plus />New contact</a>
  {/snippet}
</PageHeader>
...
<div class="v2-scroll">
  {#if contacts.length === 0}
    ...
    >
      ...
      {#snippet actions()}
        <a class="v2-btn v2-btn-primary" href="/v2/contacts/new">New contact</a>
          ...
          {#each contacts as c (c.id)}
            <tr>
              ...
              <td>
                ...
                -->
                {#if c.account}
                  <a href="/v2/accounts/{c.account.id}" style="color:inherit">{c.account.name}</a>
