  ...
  let groups = $derived([
    ...
    },
    {
      ...
      items: [
        ...
        {
          href: '/v2/settings/business-hours',
        ...
        {
          href: '/v2/settings/ticket-approvals',
        ...
        {
          href: '/v2/settings/inbound-email',
          title: 'Inbound email',
...
<div class="v2-scroll">
  <div class="v2-pad" style="padding-top:18px;padding-bottom:32px">
    ...
    <p class="v2-sub" style="font-size:11.5px;margin-top:18px;max-width:64ch">
      ...
      <a href="/v2/settings/api-tokens" style="color:inherit">API tokens</a> for how token values are
      handled.
    </p>
  </div>
</div>
