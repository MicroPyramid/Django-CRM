...
<PageHeader title="Organization">
  ...
  {#snippet actions()}
    {#if data.can_edit}
      <a class="v2-btn v2-btn-primary" href="/v2/settings/organization/edit">
        ...
        <div class="v2-card" style="padding:14px 16px">
          <div style="display:flex;gap:10px;align-items:flex-start">
            ...
            <p class="v2-sub" style="font-size:12.5px;margin:0;line-height:1.5">
              ...
              laid out is set in
              <a href="/v2/invoices/templates" style="color:inherit">invoice templates</a>.
            </p>
          </div>
        </div>
      </div>
          ...
          <div style="display:flex;gap:10px;align-items:flex-start">
            ...
            <div>
              ...
              <p class="v2-sub" style="font-size:12.5px;margin:5px 0 0;line-height:1.5">
                ...
                <a href="/v2/settings/api-tokens" style="color:inherit">API tokens</a>, which can be
