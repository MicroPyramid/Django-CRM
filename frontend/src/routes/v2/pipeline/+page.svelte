...
<PageHeader title="Pipeline">
  ...
  {#snippet actions()}
    {#if view === 'board'}
      <a class="v2-btn v2-btn-quiet" href="/v2/pipeline"><List />List</a>
      <span class="v2-btn" aria-current="true"><Columns3 />Board</span>
    {:else}
      <span class="v2-btn" aria-current="true"><List />List</span>
      <a class="v2-btn v2-btn-quiet" href="/v2/pipeline?view=board"><Columns3 />Board</a>
    {/if}
    <a class="v2-btn v2-btn-primary" href="/v2/pipeline/new"><Plus />New deal</a>
  {/snippet}
</PageHeader>
      ...
      <section class="v2-lane">
        ...
        <div class="v2-lane-body">
          ...
          {#each lane.rows as d (d.id)}
            <a class="v2-deal-card" href="/v2/pipeline/{d.id}">
...
{:else if deals.length === 0}
  <div class="v2-scroll">
    ...
    >
      ...
      {#snippet actions()}
        <a class="v2-btn v2-btn-primary" href="/v2/pipeline/new">New deal</a>
      ...
      <table class="v2-table">
        ...
        <tbody>
          {#each deals as d (d.id)}
            <tr>
              <td>
                <a class="v2-row-link" href="/v2/pipeline/{d.id}">
