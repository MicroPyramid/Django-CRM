...
<PageHeader title="Tasks">
  ...
  {/snippet}
  {#snippet actions()}
    <a class="v2-btn v2-btn-primary" href="/v2/tasks/new"><Plus />New task</a>
  {/snippet}
</PageHeader>
...
<div class="v2-scroll">
  {#if tasks.length === 0}
    ...
    >
      ...
      {#snippet actions()}
        <a class="v2-btn v2-btn-primary" href="/v2/tasks/new">New task</a>
        {#if !data.showAll}
          <a class="v2-btn" href="/v2/tasks?all=1">Show completed</a>
        {/if}
      {/snippet}
    </EmptyState>
  {:else}
    ...
    <p class="v2-sub v2-pad" style="font-size:12px;padding-bottom:24px">
      ...
      {#if !data.showAll}
        · <a href="/v2/tasks?all=1" style="color:inherit">include completed</a>
      {:else}
        · <a href="/v2/tasks" style="color:inherit">open only</a>
      {/if}
    </p>
  {/if}
</div>
