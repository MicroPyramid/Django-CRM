...
<PageHeader title={invoice.invoice_number} record>
  {#snippet crumb()}
    <a href="/v2/invoices">Invoices</a>
    <ChevronRight size={12} />
    <a href="/v2/accounts/{invoice.account.id}">{invoice.account.name}</a>
  {/snippet}
  {#snippet actions()}
    <a class="v2-btn" href="/v2/invoices/{invoice.id}/pdf" target="_blank" rel="noopener">
      Download PDF
    </a>
...
<div style="display:flex;flex:1;min-height:0;overflow:hidden">
  ...
  <aside class="v2-rail">
    ...
    <a
      href="/v2/accounts/{invoice.account.id}"
      class="v2-sub"
