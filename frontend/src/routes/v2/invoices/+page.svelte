...
<PageHeader title="Invoices">
  ...
  {/snippet}
  {#snippet actions()}
    <a class="v2-btn v2-btn-primary" href="/v2/invoices/new"><Plus />New invoice</a>
  {/snippet}
</PageHeader>
...
<div class="v2-scroll">
  {#if invoices.length === 0}
    ...
    >
      ...
      {#snippet actions()}
        <a class="v2-btn v2-btn-primary" href="/v2/invoices/new">New invoice</a>
        <a class="v2-btn" href="/v2/pipeline">Go to pipeline</a>
      {/snippet}
    </EmptyState>
  {:else}
      ...
      <table class="v2-table">
        ...
        <tbody>
          {#each invoices as inv (inv.id)}
            ...
            <tr>
              <td>
                <a class="v2-row-link" href="/v2/invoices/{inv.id}">
