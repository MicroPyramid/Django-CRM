...
<PageHeader title="Edit product" record center width="62ch">
  {#snippet crumb()}
    <a href="/v2/invoices/products">Products</a>
...
<div class="v2-scroll">
  {#if !data.can_edit}
    <div class="v2-pad" style="padding-top:24px;max-width:56ch;margin-left:auto;margin-right:auto">
      ...
      <a class="v2-btn" href="/v2/invoices/products" style="margin-top:16px">Back to products</a>
    </div>
  {:else}
    <form
      method="POST"
    ...
    >
      ...
      <div style="display:flex;gap:9px;margin-top:6px;align-items:center">
        ...
        <a class="v2-btn" href="/v2/invoices/products">Cancel</a>
      </div>
    </form>
