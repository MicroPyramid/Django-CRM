...
<PageHeader title="Estimates">
  ...
  {#snippet actions()}
    ...
    <a class="v2-btn v2-btn-primary" href="/v2/pipeline"><Plus />New estimate</a>
  {/snippet}
</PageHeader>
...
<div class="v2-scroll">
  {#if data.estimates.length === 0}
    ...
    >
      ...
      {#snippet actions()}
        <a class="v2-btn v2-btn-primary" href="/v2/pipeline">Start from a deal</a>
      {/snippet}
    </EmptyState>
  {:else}
        ...
        <tbody>
          {#each data.estimates as e (e.id)}
            ...
            <tr>
              ...
              <td>
                <a href="/v2/accounts/{e.account.id}" style="color:inherit">{e.account.name}</a>
                {#if e.opportunity}
              ...
              <td>
                {#if e.converted_invoice}
                  <a
                    href="/v2/invoices/{e.converted_invoice.id}"
                    class="v2-num"
                    style="color:inherit"
                  >
