  ...
  <div class="v2-pad" style="padding-top:40px">
    <div class="v2-card rep-locked">
      ...
      <p>
        ...
        are on the <a href="/v2/invoices">Invoices</a> and
        <a href="/v2/invoices/estimates">Estimates</a> tabs.
      </p>
    </div>
  </div>
{:else}
              ...
              {#each data.overdueByAccount as a (a.id)}
                <tr>
                  <td class="v2-table-primary">
                    <a href="/v2/accounts/{a.id}" style="color:inherit;text-decoration:none">
                      {a.name}
                    </a>
                  </td>
