	...
	{#snippet activitySection()}
		{#if selectedTemplate}
			<div class="border-t pt-4">
				<h4 class="mb-3 text-sm font-medium text-muted-foreground">Preview</h4>
				<div class="rounded-lg border p-4" style="background: linear-gradient(135deg, {selectedTemplate.primaryColor}22, {selectedTemplate.secondaryColor}22);">
