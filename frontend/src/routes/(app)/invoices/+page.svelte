...
<div class="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 p-8">
  <div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-10">
      ...
      <a href="/invoices/new" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-700 to-purple-700 text-white text-lg font-semibold rounded-xl shadow-lg hover:from-blue-800 hover:to-purple-800 transition">+ New Invoice</a>
    </div>
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-5 border-t-8 border-blue-600 relative overflow-hidden flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div class="text-right flex-shrink-0">
            ...
            <div class="flex gap-2">
              <a href="/invoices/{invoice.id}" class="px-3 py-1 bg-blue-600 text-white rounded-full text-xs font-semibold hover:bg-blue-700 transition">View</a>
              <a href="/invoices/{invoice.id}/edit" class="px-3 py-1 bg-purple-600 text-white rounded-full text-xs font-semibold hover:bg-purple-700 transition">Edit</a>
            </div>
          </div>
          <!-- Decorative gradient -->
      ...
      {#if data.invoices.length === 0}
        <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-12 text-center">
          ...
          <a href="/invoices/new" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-700 to-purple-700 text-white font-semibold rounded-xl shadow-lg hover:from-blue-800 hover:to-purple-800 transition">
            Create Invoice
          </a>
        </div>
      {/if}
