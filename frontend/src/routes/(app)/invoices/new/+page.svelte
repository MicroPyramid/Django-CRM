<script>
	...
	let lineItems = $state([{ id: crypto.randomUUID(), name: '', description: '', quantity: 1, rate: 0, amount: 0 }]);
	...
	use:enhance={() => {
		return async ({ result }) => {
			...
			if (result.type === 'success') {
				toast.success(invoice.status === 'Sent' ? 'Invoice created and sent' : 'Invoice saved as draft');
				goto('/invoices');
		...
		<div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
			<div class="flex items-center gap-4">
				...
				<div>
					...
					<p class="text-sm text-muted-foreground">Create a new invoice for your client</p>
				</div>
			</div>
					...
					<div class="space-y-4">
						...
						<div class="space-y-2">
							<div class="flex items-center gap-2">
								...
								<span class="font-medium text-muted-foreground">Auto-generated</span>
							</div>
							<div class="flex items-center gap-2">
				...
				<div class="space-y-4">
					...
					{#if invoice.contactId}
						<div class="space-y-2">
							...
							/>
							<Input
								bind:value={invoice.clientEmail}
								placeholder="Email"
								type="email"
							/>
							<Input
								bind:value={invoice.clientPhone}
								placeholder="Phone"
							/>
							<Input
								bind:value={invoice.clientAddressLine}
								placeholder="Address"
							/>
