  ...
  <main class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 pb-8">
    ...
    {:else if filteredLeads.length === 0}
      <div class="text-center py-16 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700" transition:fade>
        ...
        <a href="/leads/new" class="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 dark:bg-blue-600 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-700 transition-colors font-medium">
          <Plus class="w-4 h-4" />
          Create New Lead
        </a>
      </div>
                  ...
                  >
                    <td class="px-4 py-4">
                      <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                          <a href="/leads/{lead.id}" class="text-gray-900 dark:text-gray-100 font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors block truncate">
                            {getFullName(lead)}
                          </a>
                          {#if lead.title}
            ...
            >
              ...
              <div class="flex items-start justify-between mb-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <a href="/leads/{lead.id}" class="text-lg font-medium text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                      {getFullName(lead)}
                    </a>
                    {#if lead.title}
