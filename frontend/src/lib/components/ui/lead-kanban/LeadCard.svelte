...
>
  ...
  {#if amount}
    <div
      class="mt-1.5 flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300"
    >
  ...
  <div class="mt-2 flex items-center justify-between gap-2">
    {#if rating}
      <span
        class="rounded-full px-2 py-0.5 text-xs font-medium {ratingColors[rating] ||
