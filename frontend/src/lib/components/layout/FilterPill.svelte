<script>
  ...
  const base =
    'inline-flex h-6 items-center gap-1.5 rounded-[var(--r-sm)] px-[9px] text-[11.5px] font-medium leading-none transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[color:var(--ring)]';
  const neutral =
