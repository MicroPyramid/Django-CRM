...
from .models import Opportunity, Comments, STAGES, SOURCES, TEAMS
from .forms import OpportunityForm, CommentForm
...
def opp_create(request):
    ...
    accunt = LeadAccount.objects.all()
...
def contacts(request):
        ...
        account_contact = LeadAccount.objects.filter(id=acc)
