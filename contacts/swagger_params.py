...
contact_create_post_params = [
    ...
    openapi.Parameter('last_name', openapi.IN_QUERY, required=True, type=openapi.TYPE_STRING),
    openapi.Parameter('phone', openapi.IN_QUERY, required=True, type=openapi.TYPE_STRING),
