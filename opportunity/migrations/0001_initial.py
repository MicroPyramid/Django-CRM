            ...
            fields=[
                ...
                (
                    'amount', models.DecimalField(
                        ...
                        max_digits=12, null=True, verbose_name='Opportunity Amount',
                    ),
                ),
                (
                    'lead_source', models.CharField(
                        blank=True, choices=[
                            ('NONE', 'NONE'), ('CALL', 'CALL'), ('EMAIL', ' EMAIL'), ('EXISTING CUSTOMER', 'EXISTING CUSTOMER'), ('PARTNER', 'PARTNER'), (
                                'PUBLIC RELATIONS', 'PUBLIC RELATIONS',
                            ), ('CAMPAIGN', 'CAMPAIGN'), ('WEBSITE', 'WEBSITE'), ('OTHER', 'OTHER'),
                ...
                (
                    'assigned_to', models.ManyToManyField(
                        related_name='opportunity_assigned_to', to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
