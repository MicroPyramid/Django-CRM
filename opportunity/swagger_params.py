...
opportunity_list_get_params = [
    ...
    openapi.Parameter(
        "stage", openapi.IN_QUERY, type=openapi.TYPE_STRING
    ),
    openapi.Parameter(
        "lead_source", openapi.IN_QUERY, type=openapi.TYPE_STRING
    ),
    openapi.Parameter(
...
opportunity_detail_get_params = [
    company_params_in_header,
    openapi.Parameter(
        "opportunity_attachment", openapi.IN_QUERY, type=openapi.TYPE_FILE, 
    ),
    openapi.Parameter(
...
opportunity_create_post_params = [
    ...
    openapi.Parameter(
        "amount", openapi.IN_QUERY, type=openapi.TYPE_INTEGER
    ),
    openapi.Parameter(
        "currency", openapi.IN_QUERY, type=openapi.TYPE_STRING
    ),
    openapi.Parameter(
        "stage", openapi.IN_QUERY, type=openapi.TYPE_STRING
    ),
    ...
    openapi.Parameter(
        "probability", openapi.IN_QUERY, type=openapi.TYPE_INTEGER
    ),
    openapi.Parameter(
