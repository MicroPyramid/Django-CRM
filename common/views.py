    ...
    def get(self, request, uid, token, activation_key, format=None):
        ...
        if user:
            if timezone.now() > user.key_expires:
                ...
                context={'success':False,"message": "Link expired. Please use the Activation link sent now to your mail."}
                ...
                if user is not None and account_activation_token.check_token(
                    ...
                    context={'success':True,"message": "Thank you for your email confirmation. Now you can login to your account."}
                    return render(request, self.template, context)
