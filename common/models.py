...
from common.templatetags.common_tags import is_document_file_code
from common.templatetags.common_tags import is_document_file_image
from common.templatetags.common_tags import is_document_file_pdf
from common.templatetags.common_tags import is_document_file_sheet
from common.templatetags.common_tags import is_document_file_text
from common.templatetags.common_tags import is_document_file_video
from common.templatetags.common_tags import is_document_file_zip
...
def img_url(self, filename):
    hash_ = int(time.time())
    return '{}/{}/{}'.format('profile_pics', hash_, filename)
...
class Comment(models.Model):
    ...
    lead = models.ForeignKey(
        'leads.Lead', blank=True, null=True,
...
def document_path(self, filename):
    hash_ = int(time.time())
    return '{}/{}/{}'.format('docs', hash_, filename)
