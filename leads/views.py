...
from leads.forms import LeadAttachmentForm
from leads.forms import LeadCommentForm
...
def create_lead_from_site(request):
    ...
    return JsonResponse(
        {"error": True, "message": "In-valid data."}, status=status.HTTP_400_BAD_REQUEST,
    )
