...
class MockData {
  ...
  static final List<Lead> leads = [
    Lead(
      ...
      notes: 'Very interested in our enterprise solution. Follow up scheduled for next week.',
    ...
    Lead(
      ...
      assignedTo: 'user-2',
      tags: ['SMB', 'Consulting'],
      notes: 'Referred by existing client. Initial call went well.',
    ...
    Lead(
      ...
      notes: 'Connected on LinkedIn, interested in demo.',
    ...
    Lead(
      ...
      notes: 'Met at FinTech Summit. Ready for proposal.',
    ...
    Lead(
      ...
      assignedTo: 'user-2',
      tags: ['Retail', 'SMB'],
      notes: 'Initial call completed. Scheduling follow-up.',
    ...
    Lead(
      ...
      notes: 'Downloaded whitepaper, requesting demo.',
    ...
    Lead(
      ...
      notes: 'Interested in team collaboration features.',
