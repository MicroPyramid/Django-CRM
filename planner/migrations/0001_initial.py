            ...
            fields=[
                ...
                (
                    'event_type', models.CharField(
                        max_length=7, verbose_name='Type of the event',
                    ),
                ),
                ...
                (
                    'status', models.CharField(
                        ...
                        ], max_length=64, verbose_name='Status',
                    ),
                ),
                ...
                (
                    'duration', models.IntegerField(
                        default=None, null=True, verbose_name='Durations',
                    ),
                ),
                ...
                (
                    'assigned_to', models.ManyToManyField(
                        blank=True, related_name='event_assigned_users', to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    'attendees_contacts', models.ManyToManyField(
                        blank=True,
                        related_name='attendees_contact', to='contacts.Contact',
                    ),
                ),
                (
                    'attendees_leads', models.ManyToManyField(
                        blank=True, related_name='attendees_lead', to='leads.Lead',
                    ),
                ),
                (
                    'attendees_user', models.ManyToManyField(
                        blank=True,
                        related_name='attendees_user', to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    'content_type', models.ForeignKey(
                        blank=True, choices=[(10, 'Account'), (13, 'Lead'), (14, 'Opportunity'), (11, 'Case')], limit_choices_to=models.Q(
                            models.Q(('app_label', 'account'), ('id', 10), ('model', 'Account')), models.Q(
                                ('app_label', 'leads'), ('id', 13), (
                                    'model', 'Lead',
                                ),
                            ), models.Q(('app_label', 'opportunity'), ('id', 14), ('model', 'Opportunity')), models.Q(('app_label', 'cases'), ('id', 11), ('model', 'Case')), _connector='OR',
            ...
            fields=[
                ...
                (
                    'reminder_time', models.IntegerField(
                        blank=True, null=True, verbose_name='Reminder',
                    ),
                ),
            ],
        ),
