...
3. [CRM-Specific Colors](#crm-specific-colors)
4. [Data Visualization](#data-visualization)
5. [Kanban Board Specs](#kanban-board-specs)
6. [Activity Timeline](#activity-timeline)
7. [Typography](#typography)
8. [Spacing & Layout](#spacing--layout)
9. [Border Radius](#border-radius)
10. [Elevation & Shadows](#elevation--shadows)
11. [Components](#components)
12. [Icons](#icons)
13. [Grid & Breakpoints](#grid--breakpoints)
...
| Token                 | Hex     | RGB           | Usage                               |
| --------------------- | ------- | ------------- | ----------------------------------- |
| --color-brand-primary | #EA580C | 234, 88, 12   | Primary actions, CTAs, brand accent |
...
| --color-grey-200 | #EEEEEE | Subtle dividers, table rows        |
| --color-grey-300 | #E0E0E0 | Default borders (--border-default) |
...
| ------------------ | ------------------------ | ------- | --------------------------------- |
| **Primary**        | --color-primary-default  | #EA580C | Primary buttons, links            |
|                    | --color-primary-hover    | #C2410C | Primary hover state               |
|                    | --color-primary-active   | #9A3412 | Primary active/pressed            |
|                    | --color-primary-light    | #FFF7ED | Primary backgrounds               |
...
| --border-focus   | #EA580C    | #FB923C   | Focus rings         |
...
| Token               | Hex     | Usage                |
| ------------------- | ------- | -------------------- |
| --stage-new         | #EA580C | New/Incoming leads   |
| --stage-contacted   | #F97316 | Initial contact made |
| --stage-qualified   | #3B82F6 | Lead qualified       |
| --stage-proposal    | #8B5CF6 | Proposal sent        |
| --stage-negotiation | #F59E0B | In negotiation       |
| --stage-won         | #22C55E | Deal closed won      |
| --stage-lost        | #EF4444 | Deal closed lost     |

### Pipeline Stage Backgrounds (Kanban columns)

| Token                  | Hex     | Usage              |
| ---------------------- | ------- | ------------------ |
| --stage-new-bg         | #FFF7ED | New column         |
| --stage-contacted-bg   | #FFEDD5 | Contacted column   |
| --stage-qualified-bg   | #EFF6FF | Qualified column   |
| --stage-proposal-bg    | #F5F3FF | Proposal column    |
| --stage-negotiation-bg | #FFFBEB | Negotiation column |
| --stage-won-bg         | #F0FDF4 | Won column         |
| --stage-lost-bg        | #FEF2F2 | Lost column        |

### Activity Type Colors

| Token               | Hex     | Icon     | Usage        |
| ------------------- | ------- | -------- | ------------ |
| --activity-call     | #22C55E | Phone    | Phone calls  |
| --activity-email    | #3B82F6 | Mail     | Emails       |
| --activity-meeting  | #8B5CF6 | Calendar | Meetings     |
| --activity-task     | #F59E0B | Check    | Tasks/To-dos |
| --activity-note     | #6B7280 | FileText | Notes        |
| --activity-deadline | #EF4444 | Clock    | Deadlines    |

### Lead Temperature

| Token       | Hex     | Usage                    |
| ----------- | ------- | ------------------------ |
| --lead-hot  | #EF4444 | Hot lead (high intent)   |
| --lead-warm | #F59E0B | Warm lead (engaged)      |
| --lead-cold | #6B7280 | Cold lead (low activity) |

### Lead Temperature Backgrounds

| Token          | Hex     | Usage              |
| -------------- | ------- | ------------------ |
| --lead-hot-bg  | #FEF2F2 | Hot lead badge/tag |
| --lead-warm-bg | #FFFBEB | Warm lead badge    |
| --lead-cold-bg | #F3F4F6 | Cold lead badge    |
...
| --priority-none   | #9CA3AF | No priority set |

### Deal Health / Probability

| Token              | Hex     | Usage                     |
| ------------------ | ------- | ------------------------- |
| --probability-high | #22C55E | 70-100% close probability |
| --probability-mid  | #F59E0B | 40-69% probability        |
| --probability-low  | #EF4444 | 0-39% probability         |

### Task Status

| Token            | Hex     | Usage         |
| ---------------- | ------- | ------------- |
| --task-overdue   | #EF4444 | Past due date |
| --task-due-today | #F59E0B | Due today     |
| --task-upcoming  | #3B82F6 | Due in future |
| --task-completed | #22C55E | Completed     |
| --task-cancelled | #9CA3AF | Cancelled     |

### Task Status Backgrounds

| Token               | Hex     | Usage                |
| ------------------- | ------- | -------------------- |
| --task-overdue-bg   | #FEF2F2 | Overdue task badge   |
| --task-due-today-bg | #FFFBEB | Due today badge      |
| --task-upcoming-bg  | #EFF6FF | Upcoming task badge  |
| --task-completed-bg | #F0FDF4 | Completed task badge |
| --task-cancelled-bg | #F3F4F6 | Cancelled task badge |
...
| Token     | Hex     | Usage          |
| --------- | ------- | -------------- |
| --chart-1 | #EA580C | Primary series |
| --chart-2 | #F97316 | Secondary      |
| --chart-3 | #FB923C | Tertiary       |
| --chart-4 | #FDBA74 | Fourth         |
| --chart-5 | #FED7AA | Fifth          |
...
| Token   | Hex     | Usage               |
| ------- | ------- | ------------------- |
| --cat-1 | #EA580C | Category 1 (Orange) |
| --cat-2 | #3B82F6 | Category 2 (Blue)   |
| --cat-3 | #22C55E | Category 3 (Green)  |
| --cat-4 | #8B5CF6 | Category 4 (Purple) |
| --cat-5 | #EC4899 | Category 5 (Pink)   |
| --cat-6 | #14B8A6 | Category 6 (Teal)   |

### Progress Bar Colors

| Token              | Hex     | Usage             |
| ------------------ | ------- | ----------------- |
| --progress-default | #EA580C | Standard progress |
| --progress-success | #22C55E | Goal achieved     |
| --progress-warning | #F59E0B | Behind target     |
| --progress-danger  | #EF4444 | Critical/at risk  |
| --progress-bg      | #E5E7EB | Progress track    |
...
| Column Border Radius | --radius-lg (8px)         |
| Drop Zone Highlight  | 2px dashed --border-focus |
| Drag Shadow          | --shadow-lg               |
...
| Node Size           | 32px                       |
| Node Border         | 2px solid (activity color) |
| Node Background     | --surface-default          |
| Entry Gap           | 16px                       |
| Content Offset      | 48px from timeline         |
...
| --space-700  | 56px  | Large section gaps         |
| --space-800  | 64px  | Major section breaks       |
| --space-900  | 72px  | Extra-large spacing        |
...
| ------- | -------- | ---------------------------------------------------------------------- |
| 1.2     | Dec 2024 | Fixed font import, added spacing tokens, fixed dark mode hover states  |
| 1.1     | Dec 2024 | Orange primary color, CRM-specific tokens (pipeline, activities, etc.) |
