...
class TestMarketingModel(object):
    def setUp(self):
        ...
        self.user1 = User.objects.create(
            username="janeMarketing",
            email="janeMarketing@example.com",
            role="USER",
        ...
        self.tag_marketing = Tag.objects.create(
            name="tag marketing", created_by=self.user
        )
        ...
        self.contact_1.contact_list.add(self.contact_list.id, self.contact_list_user.id)
        ...
        self.contact_5 = Contact.objects.create(
            name="jack Doe", email="jack doe@email.com", is_bounced=True
        )
        ...
        self.campaign_scheduled_later = Campaign.objects.create(
            ...
            status="Scheduled",
            schedule_date_time=(datetime.now() + timedelta(days=2)).strftime(
                "%Y-%m-%d %H:%M"
            ),
        ...
        self.campaign_log = CampaignLog.objects.create(
            campaign=self.campaign, contact=self.contact_1
        )
...
class TestContactListsListPage(TestMarketingModel, TestCase):
    ...
    def test_contact_lists_list_page(self):
        self.client.login(username="john@example.com", password="password")
        response = self.client.get(reverse("marketing:contact_lists"))
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.post(reverse("marketing:contact_lists"), data)
        self.assertEqual(response.status_code, 200)
...
class TestContactsListPage(TestMarketingModel, TestCase):
    ...
    def test_contacts_list_page(self):
        # connections.reload('default')
        self.client.login(username="john@example.com", password="password")
        response = self.client.get(reverse("marketing:contacts_list"))
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.post(reverse("marketing:contacts_list"), data)
        self.assertEqual(response.status_code, 200)
...
class TestContactsCSVFileUploadView(TestMarketingModel, TestCase):
    def test_contacts_csv_file_upload_view(self):
        self.client.login(username="john@example.com", password="password")
        response = self.client.get(reverse("marketing:contact_list_new"))
        self.assertEqual(response.status_code, 200)
        ...
        data = {
            "contacts_file": SimpleUploadedFile("file name", file_content),
            "name": "contact file name",
            "tags": "tag1,tag2,tag marketing",
        }
...
class TestEditContact(TestMarketingModel, TestCase):
    def test_edit_contact(self):
        ...
        data = {"name": "John DOE", "email": self.contact.email}
...
class TestContactListDetail(TestMarketingModel, TestCase):
    ...
    def test_failed_contact_list_download_delete(self):
        response = self.client.get(
            reverse(
                "marketing:failed_contact_list_download_delete",
                args=(self.contact_list.id,),
            )
        )
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.get(
            reverse(
                "marketing:failed_contact_list_download_delete",
                args=(self.contact_list_user.id,),
            )
        )
        self.assertEqual(response.status_code, 302)

    def test_email_template_list(self):
        response = self.client.get(reverse("marketing:email_template_list"))
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.post(reverse("marketing:email_template_list"), data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_email_template_create(self):
        ...
        self.client.login(username="john@example.com", password="password")
        response = self.client.post(reverse("marketing:email_template_new"), data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_campaign_list(self):
        ...
        response = self.client.post(reverse("marketing:campaign_list"), data)
        self.assertEqual(response.status_code, 200)

    def test_campaign_new(self):
        self.client.login(username="john@example.com", password="password")
        response = self.client.get(reverse("marketing:campaign_new"))
        self.assertEqual(response.status_code, 200)
        ...
        self.client.login(username="john@example.com", password="password")
        response = self.client.post(reverse("marketing:campaign_new"), data)
        self.assertEqual(response.status_code, 201)
        ...
        data = {
            **data,
            "title": "wrong schedule date time",
            "schedule_date_time": (datetime.now() - timedelta(days=10)).strftime(
                "%Y-%m-%d %H:%M"
            ),
    ...
    def test_campaign_detail(self):
        ...
        response = self.client.get(
            reverse("marketing:campaign_details", args=(self.campaign.id,)) + "?page=1"
        )
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.get(
            reverse("marketing:campaign_details", args=(self.campaign.id,)) + "?page="
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_demo_file_download(self):
        response = self.client.get(reverse("marketing:demo_file_download"))
        self.assertEqual(response.status_code, 200)
    ...
    def test_download_contacts_for_campaign(self):
        ...
        response = self.client.get(
            reverse(
                "marketing:download_contacts_for_campaign", args=(self.campaign.id,)
            )
        )
        self.assertEqual(response.status_code, 403)
    ...
    def test_create_campaign_from_template(self):
        response = self.client.get(
            reverse(
                "marketing:create_campaign_from_template",
                args=(self.email_template.id,),
            )
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_delete_multiple_contacts(self):
        ...
        self.client.login(username="janeMarketing@example.com", password="password")
        response = self.client.post(reverse("marketing:delete_multiple_contacts"), data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_download_failed_contacts(self):
        ...
        response = self.client.get(
            reverse(
                "marketing:download_failed_contacts",
                args=(self.contact_list_user_1.id,),
            )
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_list_all_email_for_campaigns(self):
        self.client.login(username="john@example.com", password="password")
        response = self.client.get(reverse("marketing:list_all_emails_for_campaigns"))
        self.assertEqual(response.status_code, 200)

    def test_add_email_for_campaigns(self):
        self.client.login(username="john@example.com", password="password")
        response = self.client.get(reverse("marketing:add_email_for_campaigns"))
        self.assertEqual(response.status_code, 200)

        data = {}

        response = self.client.post(reverse("marketing:add_email_for_campaigns"), data)
        self.assertEqual(response.status_code, 200)

        data = {"name": "admin name", "email": "admin@email.com"}
    ...
    def test_edit_email_for_campaigns(self):
        ...
        response = self.client.get(
            reverse(
                "marketing:edit_email_for_campaigns",
                args=(self.contact_email_campaign.id,),
            )
        )
        self.assertEqual(response.status_code, 200)
        ...
        data = {"name": "admin name", "email": "adminContact@email.com"}
    ...
    def test_delete_email_for_campaigns(self):
        ...
        response = self.client.get(
            reverse(
                "marketing:delete_email_for_campaigns",
                args=(self.contact_email_campaign.id,),
            )
        )
        self.assertEqual(response.status_code, 302)
...
class TestContactListFileUploadForXlsxAndXls(TestMarketingModel, TestCase):
    def test_contact_list_file_upload_for_xlsx(self):
        ...
        with open(dest_filename, "rb") as fp:
            data = {"name": "sample_test xlsx", "contacts_file": fp, "tags": ""}
            response = self.client.post(reverse("marketing:contact_list_new"), data)
            self.assertEqual(response.status_code, 201)
    ...
    def test_contact_list_file_upload_for_xls(self):
        ...
        with open(dest_filename, "rb") as fp:
            data = {"name": "sample_test xls", "contacts_file": fp, "tags": ""}
            response = self.client.post(reverse("marketing:contact_list_new"), data)
            self.assertEqual(response.status_code, 201)
        os.remove(dest_filename)
...
class TestMarketingModelMethods(TestMarketingModel, TestCase):
    def test_marketing_model_methods(self):
        ...
        # self.assertTrue(
        #     self.contact_list.created_on_arrow in ["just now", "seconds ago"]
        # )
        ...
        self.assertEqual(
            ...
            self.campaign.created_on.strftime("%b %d, %Y %I:%M %p"),
        )
        self.assertEqual(
            self.contact_list.created_on_format,
