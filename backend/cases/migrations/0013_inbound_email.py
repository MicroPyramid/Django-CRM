    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default="",
                        help_text="Whitespace-separated list of RFC-5322 Message-IDs from the References header.",
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="If non-empty, the message was rejected (spam/bounce/etc.) before any Case was touched. `case` will be null in this case.",
                        max_length=64,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Null when the message was dropped (spam/bounce/auto-reply) but we still want an audit trail.",
                        null=True,
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["org", "-received_at"],
                        name="email_messa_org_id_631bc3_idx",
                    ),
                    models.Index(
                        fields=["case", "-received_at"],
                        name="email_messa_case_id_bc66f7_idx",
                    ),
                    models.Index(
                        fields=["in_reply_to"], name="email_messa_in_repl_216d84_idx"
                    ),
                ],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address",
                    models.EmailField(max_length=254, verbose_name="Inbound Address"),
                ),
                (
                    "provider",
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Shared secret / SNS Topic ARN suffix used to verify webhook calls. Auto-generated on create if left blank.",
                        max_length=128,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="inbound_mai_org_id_0a00ff_idx",
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
