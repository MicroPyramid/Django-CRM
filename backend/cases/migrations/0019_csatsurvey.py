    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["org", "-responded_at"],
                        name="csat_survey_org_id_a284b2_idx",
                    ),
                    models.Index(
                        fields=["case"], name="csat_survey_case_id_516193_idx"
                    ),
                    models.Index(
                        fields=["token_hash"], name="csat_survey_token_h_2f45f7_idx"
                    ),
                ],
            },
        ),
