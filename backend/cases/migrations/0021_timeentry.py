        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Null while the timer is running.",
                        null=True,
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["org", "profile", "started_at"],
                        name="time_entry_org_id_93126d_idx",
                    ),
                    models.Index(
                        fields=["case", "started_at"],
                        name="time_entry_case_id_b266ff_idx",
                    ),
                    models.Index(
                        fields=["billable", "invoice"],
                        name="time_entry_billabl_2174a0_idx",
                    ),
                ],
                "constraints": [
