...
class InvoiceAdmin(admin.ModelAdmin):
    list_display = ('invoice_number', 'invoice_title', 'name', 'status', 'total_amount', 'due_date', 'created_at')
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('name', 'sku', 'price', 'category', 'is_active', 'org', 'created_at')
...
class InvoiceLineItemAdmin(admin.ModelAdmin):
    list_display = ('invoice', 'description', 'product', 'quantity', 'unit_price', 'total', 'order')
