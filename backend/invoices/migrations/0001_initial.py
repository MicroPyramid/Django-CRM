    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ManyToManyField(related_name='invoice_assigned_to', to='common.profile')),
                ...
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='common.org')),
                ('teams', models.ManyToManyField(related_name='invoices_teams', to='common.teams')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='common.org')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Last Modified By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', models.TextField(blank=True, null=True, verbose_name='Details')),
                ('due_date', models.DateField(blank=True, null=True)),
                ('assigned_to', models.ManyToManyField(related_name='invoice_history_assigned_to', to='common.profile')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ...
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_histories', to='common.org')),
                ...
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoice_history_updated_by', to='common.profile')),
            ],
            options={
                ...
                'ordering': ('-created_at',),
                'indexes': [models.Index(fields=['org', '-created_at'], name='invoice_his_org_id_45400e_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoice_line_items', to='common.org')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Last Modified By')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoice_line_items', to='invoices.product')),
            ],
            options={
                ...
                'ordering': ('order',),
                'indexes': [models.Index(fields=['org', 'order'], name='invoice_lin_org_id_474821_idx')],
            },
        ),
    ]
