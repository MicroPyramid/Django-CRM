...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='org',
            name='terminology',
            field=models.JSONField(blank=True, default=dict, help_text="Label overrides, e.g. {'lead.plural': 'Enquiries'}."),
        ),
        migrations.AddField(
            model_name='org',
            name='vertical',
            field=models.CharField(blank=True, default='', help_text="Pack id applied to this org, e.g. 'real-estate'. Descriptive only.", max_length=64),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.JSONField(default=dict, help_text="{'created': [...], 'skipped': [...], 'failed': [...]}")),
                ('applied_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pack_applications', to='common.profile')),
            ...
            options={
                ...
                'ordering': ('-created_at',),
                'indexes': [models.Index(fields=['org', '-created_at'], name='pack_applic_org_id_78eec5_idx')],
            },
        ),
