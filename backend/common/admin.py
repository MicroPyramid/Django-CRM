...
from common.models import Address, Comment, CommentFiles, User, SessionToken
...
class SessionTokenAdmin(admin.ModelAdmin):
    list_display = ('user', 'token_jti_short', 'is_active', 'expires_at', 'last_used_at', 'created_at')
    list_filter = ('is_active', 'expires_at', 'created_at')
    search_fields = ('user__email', 'token_jti', 'ip_address')
    raw_id_fields = ('user',)
    readonly_fields = ('token_jti', 'refresh_token_jti', 'created_at', 'last_used_at', 'revoked_at')
