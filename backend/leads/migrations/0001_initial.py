        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "close_date",
                    models.DateField(
                        default=None, null=True, verbose_name="Expected Close Date"
                    ),
                ),
                (
                    "address_line",
                ...
                (
                    "postcode",
                    models.CharField(
                        blank=True, max_length=64, null=True, verbose_name="Postal Code"
                    ),
                ),
                (
                    "country",
                ...
                (
                    "next_follow_up",
                    models.DateField(
                        blank=True, null=True, verbose_name="Next Follow-up"
                    ),
                ),
                (
                    "description",
                ...
                (
                    "teams",
                    models.ManyToManyField(
                        related_name="lead_teams", to="common.teams"
                    ),
                ),
                (
                    "updated_by",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["source"], name="lead_source_b6a91c_idx"),
                    models.Index(
                        fields=["org", "-created_at"], name="lead_org_id_efd8ea_idx"
                    ),
                ],
            },
        ),
