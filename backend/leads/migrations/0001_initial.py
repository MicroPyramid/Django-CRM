    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='companies', to='common.org')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'lead',
                'ordering': ('-created_at',),
                'indexes': [models.Index(fields=['status'], name='lead_status_e8cfda_idx'), models.Index(fields=['source'], name='lead_source_b6a91c_idx'), models.Index(fields=['org', '-created_at'], name='lead_org_id_efd8ea_idx')],
            },
        ),
    ]
