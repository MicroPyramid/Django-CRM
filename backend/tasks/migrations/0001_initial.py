    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'task',
                'ordering': ('-due_date',),
                'indexes': [models.Index(fields=['status'], name='task_status_e9a322_idx'), models.Index(fields=['due_date'], name='task_due_dat_6ddd76_idx'), models.Index(fields=['org', '-created_at'], name='task_org_id_74b184_idx')],
            },
        ),
    ]
