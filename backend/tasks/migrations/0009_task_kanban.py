...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='task',
            name='kanban_order',
            field=models.DecimalField(decimal_places=6, default=0, help_text='Order within the kanban column for drag-drop positioning', max_digits=15, verbose_name='Kanban Order'),
        ),
        # Add stage field to Task
        migrations.AddField(
            model_name='task',
            name='stage',
            field=models.ForeignKey(blank=True, help_text='Custom pipeline stage (if using pipeline mode)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tasks', to='tasks.taskstage'),
        ),
        # Add indexes for kanban queries
        migrations.AddIndex(
            model_name='task',
            index=models.Index(fields=['status', 'kanban_order'], name='task_status_kanban_idx'),
        ),
        migrations.AddIndex(
            model_name='task',
            index=models.Index(fields=['stage', 'kanban_order'], name='task_stage_kanban_idx'),
        ),
        # Add indexes for TaskPipeline
        migrations.AddIndex(
            model_name='taskpipeline',
            index=models.Index(fields=['org', '-created_at'], name='task_pipeline_org_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['org', 'order'], name='task_stage_org_order_idx'),
        ),
        migrations.AddIndex(
            model_name='taskstage',
            index=models.Index(fields=['pipeline', 'order'], name='task_stage_pipeline_idx'),
        ),
