    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='opportunity_org', to='common.org')),
                ('tags', models.ManyToManyField(blank=True, to='accounts.tags')),
                ('teams', models.ManyToManyField(related_name='opportunity_teams', to='teams.teams')),
