        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "target_value",
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name="Target Value"
                    ),
                ),
                (
                    "period_type",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="sales_goal_org_id_363225_idx",
                    ),
                    models.Index(
                        fields=["org", "period_start", "period_end"],
                        name="sales_goal_org_id_f5e0bd_idx",
                    ),
                ],
            },
        ),
