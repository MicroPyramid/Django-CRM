    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "do_not_call",
                    models.BooleanField(default=False, verbose_name="Do Not Call"),
                ),
                (
                    "linked_in_url",
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="contact_assigned_users", to="common.profile"
                    ),
                ),
                (
                    "created_by",
                ...
                (
                    "teams",
                    models.ManyToManyField(
                        related_name="contact_teams", to="common.teams"
                    ),
                ),
                (
                    "updated_by",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["organization"], name="contacts_organiz_8cebf0_idx"
                    ),
                    models.Index(
                        fields=["org", "-created_at"], name="contacts_org_id_f280a0_idx"
                    ),
                ],
            },
        ),
