    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_email', models.EmailField(blank=True, max_length=254, null=True, verbose_name='Email')),
                ('mobile_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None, verbose_name='Phone')),
                ...
                ('linked_in_url', models.URLField(blank=True, null=True, verbose_name='LinkedIn URL')),
